...
class TestFalsePositiveManager:
    ...
    def temp_config_dir(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch("adversary_mcp_server.false_positive_manager.Path.home") as mock_home:
    ...
    def test_initialization(self, fp_manager, temp_config_dir):
        ...
        expected_config_dir = temp_config_dir / ".local" / "share" / "adversary-mcp-server"
    ...
    def test_save_false_positives_io_error(self, fp_manager):
        ...
        with patch("builtins.open", side_effect=IOError("Test error")):
            with pytest.raises(RuntimeError, match="Failed to save false positives: Test error"):
    ...
    def test_mark_false_positive_new(self, fp_manager):
        ...
        with patch.object(fp_manager, '_load_false_positives', return_value={"false_positives": [], "version": "1.0"}):
    ...
    def test_mark_false_positive_existing(self, fp_manager):
        ...
        with patch.object(fp_manager, '_load_false_positives', return_value=existing_data):
            with patch.object(fp_manager, '_save_false_positives') as mock_save:
    ...
    def test_filter_false_positives(self, fp_manager):
        ...
        with patch.object(fp_manager, 'get_false_positive_uuids', return_value={"fp-uuid"}):
    ...
    def test_import_false_positives_merge_no_duplicates(self, fp_manager, temp_config_dir):
